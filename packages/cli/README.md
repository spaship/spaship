...
@spaship/cli/0.6.0 linux-x64 node-v13.5.0
...
_See code: [src/commands/deploy.js](https://github.com/spaship/spaship/blob/v0.6.0/src/commands/deploy.js)_
...
_See code: [src/commands/init.js](https://github.com/spaship/spaship/blob/v0.6.0/src/commands/init.js)_
