...
@spaship/cli/0.9.1 darwin-x64 node-v13.7.0
...
_See code: [src/commands/deploy.js](https://github.com/spaship/spaship/blob/v0.9.1/src/commands/deploy.js)_
...
_See code: [src/commands/init.js](https://github.com/spaship/spaship/blob/v0.9.1/src/commands/init.js)_
