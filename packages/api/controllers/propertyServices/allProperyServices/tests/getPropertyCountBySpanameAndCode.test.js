...
const getPropertyCountBySpanameAndCode = require("../getPropertyCountBySpanameAndCode");

beforeAll(() => db.connect());

const mockRequest = async () => {
  return await getPropertyCountBySpanameAndCode.getPropertyCountBySpanameAndCodeService();
};

describe("check getPropertyCountBySpanameAndCode", () => {
