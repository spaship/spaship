...
const getLatestActivitiesByProperty = require("../getLatestActivitiesByProperty");

beforeAll(() => db.connect());

const mockRequest = async () => {
  return await getLatestActivitiesByProperty.getLatestActivitiesByPropertyService("one.redhat.com");
};

describe("check getLatestActivitiesByProperty", () => {
