...
const getDeploymentCountBySPAName = require("../getDeploymentCountBySPAName");

beforeAll(() => db.connect());

const mockRequest = async () => {
  return await getDeploymentCountBySPAName.getDeploymentCountBySPANameService("one.redhat.com", "home");
};

describe("check getDeploymentCountBySPAName", () => {
