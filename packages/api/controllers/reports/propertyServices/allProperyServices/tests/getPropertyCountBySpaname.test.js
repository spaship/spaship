...
const getPropertyCountBySpaname = require("../getPropertyCountBySpaname");

beforeAll(() => db.connect());

const mockRequest = async () => {
  return await getPropertyCountBySpaname.getPropertyCountBySpanameService();
}

describe("check getPropertyCountBySpaname", () => {
