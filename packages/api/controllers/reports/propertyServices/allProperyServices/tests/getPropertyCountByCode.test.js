...
const getPropertyCountByCode = require("../getPropertyCountByCode");

beforeAll(() => db.connect());

const mockRequest = async () => {
  return await getPropertyCountByCode.getPropertyCountByCodeService();
}

describe("check getPropertyCountByCode", () => {
