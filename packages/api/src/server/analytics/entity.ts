...
export enum Action {
  ...
  SYMLINK_CREATION_FAILED = 'SYMLINK_CREATION_FAILED',
  SYMLINK_CREATION_SCHEDULED = 'SYMLINK_CREATION_SCHEDULED',
  SYMLINK_DELETED = 'SYMLINK_DELETED',
  ...
  VIRTUAL_PATH_CREATED = 'VIRTUAL_PATH_CREATED',
  VIRTUAL_PATH_CREATION_FAILED = 'VIRTUAL_PATH_CREATION_FAILED',
  VIRTUAL_PATH_DELETED = 'VIRTUAL_PATH_DELETED',
  VIRTUAL_PATH_DELETION_FAILED = 'VIRTUAL_PATH_DELETION_FAILED'
}
