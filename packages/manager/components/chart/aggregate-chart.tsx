import { ChartDonut, Chart, ChartAxis, ChartGroup, ChartLine, ChartVoronoiContainer } from "@patternfly/react-charts";
...
const AggregateChart: FunctionComponent<AnyProps> = ({ type, props }: AnyProps) => {
  ...
  if (type === chartType.donut) return <ChartDonut {...props} />;
