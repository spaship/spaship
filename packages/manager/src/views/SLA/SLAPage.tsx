...
export const SLAPage = (): JSX.Element => (
  <>
    ...
    >
      <Thead noWrap>
        <Tr>
          <Th textCenter  modifier="wrap">Service Level</Th>
          <Th textCenter  modifier="wrap">Response Time(Business Hours IST)</Th>
          <Th textCenter  modifier="wrap">Resolution Time(Business Hours IST)</Th>
          <Th textCenter  modifier="wrap">Response Time(After Business Hours)</Th>
          <Th textCenter  modifier="wrap">Resolution Time(After business hours)</Th>
          <Th textCenter  modifier="wrap">Contact	</Th>
          <Th textCenter  modifier="wrap">Escalation</Th>
          <Th textCenter  modifier="wrap">Description	</Th>
          <Th textCenter  modifier="wrap">Cases</Th>
          <Th textCenter  modifier="wrap">RCA(Root cause analysis)</Th>
        </Tr>
      </Thead>
      <Tbody>
        ...
        <Tr >
          ...
          <Td>8 hours</Td>
          <Td>12 hours</Td>
          <Td><b>Email : </b>spaship-dev@redhat.com <br/>
            <b>Slack : </b>forum-spaship - Internal Red Hat - Slack</Td>
          <Td>npatil@redhat.com
            arbhatta@redhat.com</Td>
          <Td>Critical issue that impacts a high number of end users or critical business functions.</Td>
          <Td>
        ...
        <Tr>
          ...
          <Td>
            arbhatta@redhat.com
            schowd@redhat.com</Td>
          <Td>Significant issue that impacts some end users or non-critical business functions.</Td>
          <Td>
        ...
        <Tr>
          ...
          <Td>schowd@redhat.com
            spaship-dev@redhat.com	</Td>
          <Td>Minor issue that affects a small number of end users or non-critical business functions.	</Td>
          <Td>
