...
//   const panelContent = (
//     <DrawerPanelContent>
//       {console.log('0099 inside panel conten', activeTabKey === 0 ? 'POD' : 'BUILD')}
//       <DrawerHead>
//         <b>Logs for {propertyIdentifier}</b>
...
// //   buildID: string
// // ) => {
// //   console.log('inside use', propertyIdentifier, env, spaName, logsType, buildID);
// //   const { isLoading, isSuccess, data } = useGetLogsforSpa(
// //     propertyIdentifier,
// //     spaName,
// //     env,
...
// //     buildID
// //   );
// //   console.log('data ddd', useGetLogsforSpa(propertyIdentifier, spaName, env, logsType, buildID));
// //   useEffect(() => {
// //     console.log('data', data, isLoading, isSuccess, logsType);
// //   }, [data, isLoading, isSuccess, logsType]);
...
// //   };
// //   const podList = useListOfPods(propertyIdentifier, spaName, env);
// //   // const defaultID = idList && idList[idList.length - 1];
// //   // const pID = type === 0 ? (selectedId !== '' ? selectedId : podList?.data?.[0]) : '';
// //   const buildID = selectedId !== '' ? selectedId : idList && idList[idList.length - 1];
...
// //   console.log('>>>>', logsType, type === 0 ? 'POD' : 'BUILD', buildID, data);

// //   useEffect(() => {
// //     const log = type === 0 ? 'POD' : 'BUILD';
// //     setLogsType(log);
// //     setSelectedId('');
// //   }, [type]);
